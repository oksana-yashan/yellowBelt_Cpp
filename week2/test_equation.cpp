...
void TestRootCount() {
  AssertEqual(GetDistinctRealRootCount(1,4,4), 1, "1 roots");
  AssertEqual(GetDistinctRealRootCount(1,3,2), 2, "2 roots");
  AssertEqual(GetDistinctRealRootCount(1,1,1), 0, "0 root");
  AssertEqual(GetDistinctRealRootCount(2,4,2), 1, "1 root");
  AssertEqual(GetDistinctRealRootCount(0,4,4), 1, "1 root");
  AssertEqual(GetDistinctRealRootCount(0,0,4), 0, "0 roots");
}
...
int main() {
  ...
  runner.RunTest(TestRootCount2, "TestRootCount2");
